...
export const uiText = {
  en: {
    ...
    fastProofFirst: "Quick CV",
    exploreSystems: "Deep Dive",
    recruiter: "Quick CV",
    explorer: "Deep Dive",
    modeIntro: "Choose Quick CV for a recruiter scan, or Deep Dive to explore the systems behind the projects.",
    quickModeDescription: "Fit, proof, CV, and contact.",
    deepModeDescription: "Screenshots, workflows, systems, and case studies.",
    quickModeStatus: "Viewing: Quick CV — optimized for a 60-second recruiter scan.",
    deepModeStatus: "Viewing: Deep Dive — project workflows and proof.",
    ...
    skillsText:
      "The value is not knowing isolated tools. It is understanding the work, shaping the system, and turning the result into something people can use.",
  ...
  es: {
    ...
    fastProofFirst: "CV rápido",
    exploreSystems: "A fondo",
    recruiter: "CV rápido",
    explorer: "A fondo",
    modeIntro: "Elige CV rápido para revisar el perfil en un minuto, o A fondo para ver proyectos, flujos y evidencia.",
    quickModeDescription: "Encaje, evidencia, CV y contacto.",
    deepModeDescription: "Capturas, flujos, sistemas y casos.",
    quickModeStatus: "Viendo: CV rápido — optimizado para una revisión de 60 segundos.",
    deepModeStatus: "Viendo: A fondo — flujos de proyecto y evidencia.",
    ...
    systemBuilt: "Sistema construido",
    workflowLabel: "Flujo",
...
const signalCardsEs = [
  ...
  { label: "SaaS/Producto", value: "2 años", detail: "precios SaaS y procesos de ingresos" },
